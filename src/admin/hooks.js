/* Solva admin · hooks de datos.
   Envuelven la capa db (Supabase) para el panel: sesión, catálogo, stock y
   configuración. Todos re-renderizan en vivo suscribiéndose a los cambios
   de db. */
...
export const DEFAULT_WA_PHONE = BRAND.waPhone;
