...
import { useAuth, useProducts, useStock, useCfg } from "./hooks.js";
    ...
    <div className="adm-shell">
      <aside className="adm-sidebar">
        <div className="adm-sb-top">
          <span className="adm-sb-logo">{BRAND.name}</span>
      ...
      <div className="adm-body">
        <header className="adm-hdr">
          ...
          <span className="adm-hdr-meta">{BRAND.name} · Panel en la nube</span>
      ...
      <div className="adm-mob-menu" data-on={menuOpen ? "1" : "0"} aria-hidden={!menuOpen}>
        <div className="adm-mob-menu-hdr">
          <span className="adm-mob-menu-brand">{BRAND.name}</span>
      ...
      {!ready ? (
        <div className="adm-login-wrap">
          <div className="adm-login-card">
            <div className="adm-login-logo">{BRAND.name}</div>
