/* Solva admin · registro manual de un pedido cerrado por el vendedor.
...
function orderDraftKey(fixedPhone) {
  return "solva_order_draft_" + (fixedPhone || "blank");
}
...
export function OrderForm({ phone: fixedPhone, customerName: fixedName, onClose, onCreated }) {
  ...
  // Guarda el borrador en cada cambio; así sobrevive a un clic afuera.
  useEffect(() => {
    try {
        ...
        <header className="adm-order-form-hdr">
          <div>
            ...
            <p className="adm-hint">
              Para ventas cerradas por el vendedor fuera del sitio (WhatsApp, llamada, en
              persona). Queda visible en Despachos.
            </p>
          </div>
          <button
            type="button"
              ...
              <div className="adm-form-grid">
                ...
                <div className="adm-form-field adm-form-field--full">
                  ...
                  <input
                    ...
                    placeholder="Producto A(talla M)x1, Producto B x2"
                    name="order-items"
                    autoComplete="off"
                  />
                </div>
