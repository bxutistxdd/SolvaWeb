/* Solva · cajón lateral del carrito.
   Lista los items con su estado de stock y el total, y al confirmar abre un
   link directo de WhatsApp (wa.me) con el resumen del pedido en texto plano.
   No hay paso intermedio de cotización ni backend involucrado: es
   carrito → wa.me. */
...
export function CartDrawer({ open, onClose, cart, waPhone }) {
  ...
  const toWhatsApp = () => {
    ...
    const msg = [
      ...
      ...lines,
      "",
      `Total: ${VETA_DATA.fmtPrice(cart.total)} COP`,
      "",
