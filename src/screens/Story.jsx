/* Solva · nuestra historia (contenido estático, sin backend). */
  ...
  const steps = [
    {
      ...
      body: `${BRAND.name} nació hace poco. Hoy seleccionamos con cuidado cada pieza de nuestro catálogo, y trabajamos para tener, muy pronto, producción propia.`,
    },
    {
      n: "02",
